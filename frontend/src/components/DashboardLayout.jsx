      ...
      <aside className={`sidebar glass-dark ${open ? 'open' : ''}`}>
        <div className="sidebar-brand">
          ...
          <div className="sidebar-brand-content">
            <div className="sidebar-brand-text">Shah College</div>
            <span className="sidebar-brand-role">{title} {t('dashboard_panel', 'Panel')}</span>
          </div>
        </div>
